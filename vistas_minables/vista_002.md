...
[ Aca se esta intentando probar sin las variables de hora de vuelo ni dia, que suuponemos meten ruido al modelo.]
...
1. **Limpieza**: Columnas eliminadas: `id_vuelo, hora_salida_programada, dia_semana`
